...
- Large-scale GCNs
observations:
  skip: HE-encrypted GCN adjacency matrices replicate the same blocks across ciphertexts, so a
    large share of homomorphic multiplications recompute products already known to be identical.
official_category: ''
optimization_type: []
